$(document).ready(function () {
  ...
  function createFruitsAndVegCard(result) {
    ...
    if (count == 0) {
      $("#fruit-shop").empty();
      $("#fruit-shop").html(
        "<div class='no-products-text'>No fruits or vegetables</div>"
      );
    } else {
      let img = "";
      let output = ``;
  ...
  function createTaggedCard(result, tag, container) {
    ...
    if (count == 0) {
      container.empty();
      container.html(
        `<div class='no-products-text'>No products of this kind</div>`
      );
    } else {
      let img = "./Public/assets/default.jpg";
      let output = ``;
  ...
  $("body").on("click", ".add-to-cart", function (e) {
    ...
    if (!localStorage.getItem("authToken")) {
      ...
      const quantity = $(this)
        .parent()
        .parent()
        .children(".quantity-input-container")
        ...
        .then((result) => {
          if (result.error) {
            ...
            $(this)
              ...
              .parent()
              .children(".quantity-input-container")
              .children(".nice-number")
              .hide();
            let increaseContainer = $(this)
              .parent()
              .parent()
              .children(".quantity-input-container")
              .children(".increase-container")
              .removeClass("hidden");
    ...
    fetch(decrease_api, requestOptions)
      ...
      .then((result) => {
        ...
        if (current_text == 0) {
          $(this).parent().hide();
          $(this)
            .parents(".quantity-input-container")
            .children()
            .find(".product-quantity")
            .show();
          $(this)
  ...
  $("#search-input-btn").on("click", function (e) {
    ...
    const search_api = `https://yourstore-swe.herokuapp.com/searchItem/${sessionStorage.getItem(
      "shopID"
    )}?search=${searchQuery}`;
