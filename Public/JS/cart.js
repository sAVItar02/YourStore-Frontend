$(document).ready(function () {
  ...
  $("body").on("click", ".choose-address", function (e) {
    ...
    if (
      ...
      !sessionStorage.getItem("shopInCart")
    ) {
  ...
  $(".add-new-address-btn").on("click", function (e) {
    ...
    try {
      ...
      let location = `${$("#flat-no").val()}, ${$("#locality").val()}, ${$(
        "#landmark"
      ).val()}`;
  ...
  function getCart() {
    if (sessionStorage.getItem("shopInCart") == "undefined") {
      ...
      const get_shop_api = `https://yourstore-swe.herokuapp.com/shop/${sessionStorage.getItem(
        "shopInCart"
      )}`;
  ...
  $("body").on("click", ".increase-quantity", function (e) {
    ...
    $(this)
      .parents(".cart-items")
      .children(".cart-overlay")
      .removeClass("hidden");
    $(this)
      .parents(".cart-items")
      .children(".cart-spinner")
      .removeClass("hidden");
