$(document).ready(function () {
    ...
    try {
      getProfile().then((result) => {
        ...
        if (result.paymentHistory.length == 0) {
          $(".payments").empty();
          $(".payments").html(
            "<div class='no-products-text'>No payments yet!</div>"
          );
        } else {
          let output = ``;
          result.paymentHistory.forEach((item) => {
            ...
            output += `
                        <div class="payment-card">
                            ...
                            <strong class="shopID-text">Shop Name:</strong>${
                              item.shopName
                            }
                            </div>
    ...
    getProfile().then((result) => {
      ...
      if (result.PendingOrders.length == 0) {
        ...
        $(".orders-container").html(
          "<div class='no-products-text'>No orders yet!</div>"
        );
      } else {
        console.log(result);
    ...
    getProfile().then((result) => {
      if (result.address.length == 0) {
        ...
        $(".address-container").html(
          "<div class='no-products-text'>No addresses added!</div>"
        );
      } else {
        let output = ``;
  ...
  $(".logout").on("click", function (e) {
    ...
    playAudio("./../../Public/assets/Sounds/Log Out.mp3");
